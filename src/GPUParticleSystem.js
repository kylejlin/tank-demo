...
import particle2Src from './images/particle2.png';
import perlin512Src from './images/perlin-512.png';
...
THREE.GPUParticleSystem = function(options) {
	...
	self.particleNoiseTex = self.PARTICLE_NOISE_TEXTURE || textureLoader.load(perlin512Src);
	self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	// sprite texture rendered for each particle
	self.particleSpriteTex = self.PARTICLE_SPRITE_TEXTURE || textureLoader.load(particle2Src);
...
export default THREE.GPUParticleSystem;
